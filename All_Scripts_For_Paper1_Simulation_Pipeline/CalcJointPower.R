...
for(ii in 1:length_effect_size){
  ...
  for(jj in 1:numSims){
    SSFiles15[jj,] = paste0("PValues_ScoreAndJoint_SingleSNPs_15PercentAR_EffectSize_",effect_size_range[ii],"_Simulation",jj,".csv")
  }
  ...
  #write files out
  write.csv(allFiles15.IBS.SNP.All.Power, paste0("IBSScoresSS_ScoreAndJointPower_Chr",chr,"_",numSamples,"Pairs_15PercentAR_",gene,"_ES_",effect_size_range[ii],".csv"))
  write.csv(allFiles15.Incomp.SNP.All.Power, paste0("IncompScoresSS_ScoreAndJointPower_Chr",chr,"_",numSamples,"Pairs_15PercentAR_",gene,"_ES_",effect_size_range[ii],".csv"))
  write.csv(allFiles15.MM.SNP.All.Power, paste0("MMScoresSS_ScoreAndJointPower_Chr",chr,"_",numSamples,"Pairs_15PercentAR_",gene,"_ES_",effect_size_range[ii],".csv"))
  write.csv(allFiles15.BeagleIBD.All.Power, paste0("BeagleIBDProbs_ScoreAndJointPower_Chr",chr,"_",numSamples,"Pairs_15PercentAR_",gene,"_ES_",effect_size_range[ii],".csv"))
}
...
for(ii in 1:length_effect_size){
  ...
  for(jj in 1:numSims){
    SSFiles30[jj,] = paste0("PValues_ScoreAndJoint_SingleSNPs_30PercentAR_EffectSize_",effect_size_range[ii],"_Simulation",jj,".csv")
  }
  ...
  #write files out
  write.csv(allFiles30.IBS.SNP.All.Power, paste0("IBSScoresSS_ScoreAndJointPower_Chr",chr,"_",numSamples,"Pairs_30PercentAR_",gene,"_ES_",effect_size_range[ii],".csv"))
  write.csv(allFiles30.Incomp.SNP.All.Power, paste0("IncompScoresSS_ScoreAndJointPower_Chr",chr,"_",numSamples,"Pairs_30PercentAR_",gene,"_ES_",effect_size_range[ii],".csv"))
  write.csv(allFiles30.MM.SNP.All.Power, paste0("MMScoresSS_ScoreAndJointPower_Chr",chr,"_",numSamples,"Pairs_30PercentAR_",gene,"_ES_",effect_size_range[ii],".csv"))
  write.csv(allFiles30.BeagleIBD.All.Power, paste0("BeagleIBDProbs_ScoreAndJointPower_Chr",chr,"_",numSamples,"Pairs_30PercentAR_",gene,"_ES_",effect_size_range[ii],".csv"))
}