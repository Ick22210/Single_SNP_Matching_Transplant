...
mismatchPlink[(DGenosMat != 2) & (RGenosMat == 2)] = 1
mismatchPlink[(DGenosMat != 0) & (RGenosMat == 0)] = 1
...
write.csv(mismatchPlink, paste0("Var_Chr",chr,"_",numSamples,"Pairs_",gene,"_BinaryMismatch_Unsummed_Simulation",simNum,".csv"))
